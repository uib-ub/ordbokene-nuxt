...
<main class="secondary-page">
  ...
  <div v-if="$i18n.locale === 'eng'">
    ...
    <details>
      <summary><h3>What if I cannot find a word in the dictionary?</h3></summary>
    ...
    <details>
      <summary><h3>Quality-Assured Content</h3></summary>
    ...
    <details>
      <summary><h3>Citing the dictionaries</h3></summary>
    ...
    <details>
      <summary><h3>Open Data</h3></summary>
    ...
    <details>
      <summary><h3>Dictionary revision</h3></summary>
