<template>
  <div class="md:mx-10">
      <NuxtLink v-if="store.view == 'article' && store.searchUrl" class="back-link pb-1 border-none" :to="store.searchUrl"> <strong><CustomIcon icon="bi-arrow-left" primary/></strong> {{$t('notifications.back')}}</NuxtLink>
