...
<template>
    <div>
    <div class="callout" v-if="different"><BootstrapIcon icon="bi-info-circle-fill" /> <strong>{{different}}</strong> er ikke et oppslagsord i {{store.dict}}. Viser ordet <strong>{{$route.params.slug[0]}}</strong>.
