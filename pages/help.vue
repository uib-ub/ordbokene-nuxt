...
<div v-if="$i18n.locale === 'eng'">
  <p>Search the website by entering a word, press <kbd>return</kbd> or pick a search suggestion in the drop-down menu. Press <kbd>/</kbd> whenever you want to jump back to the search box.
    ...
    The dictionary from which to get search results depends on the dictionary selected, and if the word is used in both written languages. Currently, the two dictionaries are not linked at word level. Thus a ‘Did you mean’ function has been developed. The hope is that this function will be helpful in finding the right words in both <span lang="no">Bokmål</span> and <span lang="no">Nynorsk</span>. It is possible to search for fixed expressions, e.g.
    <em lang="no">gi katten i</em> (not give a damn). It is also possible to find such expressions at the end of each article or the articles they are linked to. When typing a single word in the search field, the drop-down menu also shows the common expressions the word is part of.
</p>
...
Examples:
<p>The search query “<a href="https://ordbokene.no/bm,nn/search?q=arbeid%2ar&scope=ei">arbeid*r</a>”, will result in results in the drop-down menu with “<span lang="no">arbeider</span>” (worker) in the <span lang="no">Bokmål</span> dictionary and “<span lang="nn">arbeidar</span>” (worker) in the <span lang="no">Nynorsk</span> Dictionary.</p>
<p>The search query “<a href="https://ordbokene.no/bm,nn/search?q=inter%25es%25ant&scope=ei">inter%es%ant</a>” returns the result “<span lang="no">interessant</span>” (interesting) in both dictionaries. </p>
<p>The search query “<a href="https://ordbokene.no/bm,nn/search?q=f%C3%B8rsk%25l%C3%A6r_r&scope=ei">førsk%lær_r</a>” gives resutls for “<span lang="no">førskolelærer</span>” (pre-school teacher) in the <span lang="no">Bokmål</span> dictionary and “<span lang="nn">førskolelærar/førskulelærar</span>” (pre-school teacher) in the <span lang="no">Nynorsk</span> dictionary.</p>
...
Examples:
<p>The search “<a href="https://ordbokene.no/bm,nn/search?q=kj%C3%A6rlighet%7Ckj%C3%A6rleik&scope=ei">kjærlighet|kjærleik</a>” yields the result “<span lang="no">kjærlighet</span>” in the <span lang="no">Bokmål</span> dictionary and “<span lang="nn">kjærleik</span>” (love) in the <span lang="no">Nynorsk</span> dictionary.</p>
<p>The search “<a href="https://ordbokene.no/bm,nn/search?q=undervis_r%7Cl%C3%A6r_r&scope=ei">undervis_r|lær_r</a>” results in “<span lang="no">underviser</span>” (teacher) and “<span lang="no">lærer</span>” (teacher) in the <span lang="no">Bokmål</span> dictionary and “<span lang="nn">undervisar</span>” and “<span lang="nn">lærar</span>” in the <span lang="no">Nynorsk</span> dictionary.</p>
  </div>
