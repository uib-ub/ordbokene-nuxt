...
<main class="secondary-page">
  ...
  <div v-if="$i18n.locale === 'eng'">
    ...
    <div class="accordion-item">
      <h3 class="accordion-header" id="flush-headerFour">
    ...
    <div class="accordion-item">
      <h3 class="accordion-header" id="flush-headerFive">
    ...
    <div class="accordion-item">
      <h3 class="accordion-header" id="flush-headerSix">
    ...
    <div class="accordion-item">
      <h3 class="accordion-header" id="flush-headerSeven">
    ...
    <div class="accordion-item">
      <h3 class="accordion-header" id="flush-headerEight">
    ...
    <div class="accordion-item">
      <h3 class="accordion-header" id="flush-headerNine">
  ...
  <div v-if="$i18n.locale === 'nno'">
    ...
    <details>
      <summary><h3>Bruk av ordbøkene.no i skulen</h3></summary>
    ...
    <details>
      <summary><h3>Personvern</h3></summary>
  ...
  <div v-if="$i18n.locale === 'nob'">
    ...
    <details>
      <summary><h3>Hva betyr det om du ikke finner et ord i ordboka?</h3></summary>
      <div>
    ...
    <details>
      <summary><h3>Kvalitetssikret innhold</h3></summary>
      <div>
    ...
    <details>
      <summary><h3>Åpne data</h3></summary>
      <div>
